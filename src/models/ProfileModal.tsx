...
function ProfileModal({ open, handleDialogCloseBtnClick, text, details }: IViewDialogProp): ReactNode {
  return (
        ...
        <Box component="div">
          <fieldset disabled className='py-4 border border-dashed rounded-md border-slate-400'>
            ...
            <Box component="div" className='flex items-center justify-center gap-x-2 gap-y-4 flex-wrap p-2'>
              ...
              <TextField label="Phone" className='uppercase' value={details?.phone} disabled fullWidth />
            </Box>
