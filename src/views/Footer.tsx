...
function Footer() {
  return (
    <section className='overflow-hidden bg-gradient-to-tr from-indigo-950 to-blue-950 via-zinc-900 py-4 text-xs px-1 sm:px-0 font-bold' style={{ fontFamily: "Roboto" }}>
      <div className='grid lg:grid-cols-3 text-zinc-200'>
        <div className='sm:p-1 lg:border-r text-center'>
          <p className='flex justify-center items-center'>Made in
